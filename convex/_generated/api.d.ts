...
import type * as pipeline_assetsCatalogue from "../pipeline/assetsCatalogue.js";
import type * as pipeline_assetsIngest from "../pipeline/assetsIngest.js";
import type * as pipeline_assetsTagSchema from "../pipeline/assetsTagSchema.js";
import type * as pipeline_assetsTagging from "../pipeline/assetsTagging.js";
import type * as pipeline_avatar_assign from "../pipeline/avatar/assign.js";
import type * as pipeline_avatar_catalogue from "../pipeline/avatar/catalogue.js";
import type * as pipeline_avatar_catalogueData from "../pipeline/avatar/catalogueData.js";
import type * as pipeline_avatar_heygen from "../pipeline/avatar/heygen.js";
import type * as pipeline_avatar_jobs from "../pipeline/avatar/jobs.js";
import type * as pipeline_avatar_pricing from "../pipeline/avatar/pricing.js";
import type * as pipeline_avatar_videoTitle from "../pipeline/avatar/videoTitle.js";
...
import type * as pipeline_institutionTheme from "../pipeline/institutionTheme.js";
...
import type * as pipeline_publishedCourses from "../pipeline/publishedCourses.js";
import type * as pipeline_queries from "../pipeline/queries.js";
import type * as pipeline_render from "../pipeline/render.js";
...
import type * as pipeline_sourceDocFacts from "../pipeline/sourceDocFacts.js";
...
import type * as pipeline_tts_beats from "../pipeline/tts/beats.js";
import type * as pipeline_tts_calls from "../pipeline/tts/calls.js";
import type * as pipeline_tts_data from "../pipeline/tts/data.js";
import type * as pipeline_tts_edit from "../pipeline/tts/edit.js";
import type * as pipeline_tts_elevenlabs from "../pipeline/tts/elevenlabs.js";
import type * as pipeline_tts_hashes from "../pipeline/tts/hashes.js";
import type * as pipeline_tts_lexicon from "../pipeline/tts/lexicon.js";
import type * as pipeline_tts_mock from "../pipeline/tts/mock.js";
import type * as pipeline_tts_models from "../pipeline/tts/models.js";
import type * as pipeline_tts_normalize from "../pipeline/tts/normalize.js";
import type * as pipeline_tts_preview from "../pipeline/tts/preview.js";
import type * as pipeline_tts_pricing from "../pipeline/tts/pricing.js";
import type * as pipeline_tts_provider from "../pipeline/tts/provider.js";
import type * as pipeline_tts_script from "../pipeline/tts/script.js";
import type * as pipeline_tts_synthesize from "../pipeline/tts/synthesize.js";
import type * as pipeline_tts_voice from "../pipeline/tts/voice.js";
import type * as pipeline_workflows from "../pipeline/workflows.js";
import type * as publicCourseMedia from "../publicCourseMedia.js";
import type * as publicCourses from "../publicCourses.js";
...
declare const fullApi: ApiFromModules<{
  ...
  "pipeline/assetsCatalogue": typeof pipeline_assetsCatalogue;
  "pipeline/assetsIngest": typeof pipeline_assetsIngest;
  "pipeline/assetsTagSchema": typeof pipeline_assetsTagSchema;
  "pipeline/assetsTagging": typeof pipeline_assetsTagging;
  "pipeline/avatar/assign": typeof pipeline_avatar_assign;
  "pipeline/avatar/catalogue": typeof pipeline_avatar_catalogue;
  "pipeline/avatar/catalogueData": typeof pipeline_avatar_catalogueData;
  "pipeline/avatar/heygen": typeof pipeline_avatar_heygen;
  "pipeline/avatar/jobs": typeof pipeline_avatar_jobs;
  "pipeline/avatar/pricing": typeof pipeline_avatar_pricing;
  "pipeline/avatar/videoTitle": typeof pipeline_avatar_videoTitle;
  ...
  "pipeline/institutionTheme": typeof pipeline_institutionTheme;
  ...
  "pipeline/tts/beats": typeof pipeline_tts_beats;
  "pipeline/tts/calls": typeof pipeline_tts_calls;
  "pipeline/tts/data": typeof pipeline_tts_data;
  "pipeline/tts/edit": typeof pipeline_tts_edit;
  "pipeline/tts/elevenlabs": typeof pipeline_tts_elevenlabs;
  "pipeline/tts/hashes": typeof pipeline_tts_hashes;
  "pipeline/tts/lexicon": typeof pipeline_tts_lexicon;
  "pipeline/tts/mock": typeof pipeline_tts_mock;
  "pipeline/tts/models": typeof pipeline_tts_models;
  "pipeline/tts/normalize": typeof pipeline_tts_normalize;
  "pipeline/tts/preview": typeof pipeline_tts_preview;
  "pipeline/tts/pricing": typeof pipeline_tts_pricing;
  "pipeline/tts/provider": typeof pipeline_tts_provider;
  "pipeline/tts/script": typeof pipeline_tts_script;
  "pipeline/tts/synthesize": typeof pipeline_tts_synthesize;
  "pipeline/tts/voice": typeof pipeline_tts_voice;
  "pipeline/workflows": typeof pipeline_workflows;
  publicCourseMedia: typeof publicCourseMedia;
  publicCourses: typeof publicCourses;
