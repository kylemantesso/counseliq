...
import { Pressable, View, ScrollView } from '../../rn-primitives';
...
const modalStyle = tva({
  ...
  variants: { size: { xs: '', sm: '', md: '', lg: '', full: '' } },
});
...
const modalBodyStyle = tva({ base: 'mt-2 mb-6' });
const modalHeaderStyle = tva({ base: 'justify-between items-center flex-row' });
const modalFooterStyle = tva({ base: 'flex-row justify-end items-center gap-2' });
...
>(function ModalHeader({ className, ...props }, ref) {
  return <UIModal.Header ref={ref} {...props} className={modalHeaderStyle({ class: className })} />;
});
...
>(function ModalBody({ className, ...props }, ref) {
  return <UIModal.Body scrollEnabled={false} ref={ref} {...props} className={modalBodyStyle({ class: className })} />;
});
...
>(function ModalFooter({ className, ...props }, ref) {
  return <UIModal.Footer ref={ref} {...props} className={modalFooterStyle({ class: className })} />;
});
...
>(function ModalCloseButton({ className, ...props }, ref) {
  return <UIModal.CloseButton ref={ref} {...props} className={modalCloseButtonStyle({ class: className })} />;
});
